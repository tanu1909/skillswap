    ...
    <div style={{ padding: '40px', maxWidth: '800px', margin: '0 auto', fontFamily: 'sans-serif' }}>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '20px' }}>
        ...
        <div style={{ display: 'flex', gap: '10px' }}>
          <Link to="/profile" style={{ padding: '8px 14px', background: 'var(--color-accent)', color: '#fff', textDecoration: 'none', borderRadius: '6px' }}>Edit Profile</Link>
          <Link to="/dashboard" style={{ padding: '8px 14px', background: 'var(--color-card)', color: 'var(--color-text)', textDecoration: 'none', borderRadius: '6px' }}>Back</Link>
        </div>
      </div>
      ...
      <div style={{ background: 'var(--color-card)', padding: '20px', borderRadius: '12px', border: '1px solid var(--color-border)' }}>
        ...
        <h4 style={{ marginTop: 16 }}>Skills Wanted</h4>
        <div style={{ display: 'flex', gap: 8, flexWrap: 'wrap', marginTop: 8 }}>
